...
- [ ] Implement vertical markers in canvas, including rendering, drag interaction, and marker callbacks.
- [ ] Implement marked region highlighting in canvas, including destination-focused region scroll behavior.
