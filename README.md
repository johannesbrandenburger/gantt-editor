...
- **dragging** on the chart lets the user **select multiple slots** (brush selection)
...
- hold **alt** while moving a selection to **copy instead of move** (native copy cursor and green destination preview)
